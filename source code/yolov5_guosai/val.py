...
def parse_opt():
    ...
    parser.add_argument('--data', type=str, default=ROOT / 'data/coco128.yaml', help='dataset.yaml path')  # 修改处
    parser.add_argument('--weights', nargs='+', type=str, default=ROOT / 'yolov5x.pt', help='model.pt path(s)')  # 修改处
    parser.add_argument('--batch-size', type=int, default=1, help='batch size')  # 修改处
    parser.add_argument('--imgsz', '--img', '--img-size', type=int, default=640, help='inference size (pixels)')    #修改处
